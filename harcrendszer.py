...
def harc(player_ATK, player_DEF, player_DAM, player_HP, enemy_ATK, enemy_DEF, enemy_DAM, enemy_HP, enemy_NAME):
    ...
    print("")
    harc_menu(player_ATK, player_DEF, player_DAM, player_HP, enemy_ATK, enemy_DEF, enemy_DAM, enemy_HP, enemy_NAME)

def harc_menu(player_ATK, player_DEF, player_DAM, player_HP, enemy_ATK, enemy_DEF, enemy_DAM, enemy_HP, enemy_NAME):

    print("1 - Neki támadsz")
    print("2 - Elmenekülsz")
    valasz = int(input("Választásod: "))
    if valasz == 1:
        harc(player_ATK, player_DEF, player_DAM, player_HP, enemy_ATK, enemy_DEF, enemy_DAM, enemy_HP, enemy_NAME)
        os.system("cls")
    else:
        return
harc_menu(40, 100, 4, 100, 30, 99, 2, 50, "Anyád")