...
def fomenu():
    ...
    visszaugras = 1
    print('------------------------------------------------------------------')
    prPurple('A híres DisneyLand varázslatos országának bejáratánál tartózkodsz.')
                                                        ...
                                                        if arany >= 60:
                                                            ...
                                                            while veszeljegy > 2 or veszeljegy < 1:
                                                                ...
                                                                match veszeljegy:
                                                                    case 1:
                                                                        arany -= 60
                                                                        elszakad_vagy_nem = random.randint(2)
                                                            ...
                                                            print('--------------------------------------------------------')
                                                            print('Opciók')
                                                            prRed('\t 1 - Mivel nincs pénzed a jegyre, kilépsz a kastélyból')
                                                            print('\t 2 - Maradsz a kastélyban')
                                                            print('--------------------------------------------------------')
                                                            maradsz_e = 3
